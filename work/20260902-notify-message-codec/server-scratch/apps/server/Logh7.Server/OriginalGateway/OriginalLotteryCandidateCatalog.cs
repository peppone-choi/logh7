...
public static class OriginalLotteryCandidateCatalog
{
    ...
    [
        new(0x70000001, "ヤン・ウェンリー", OriginalFaction.Alliance, 1, 1,
            "ヤン", "ウェンリー", "プレアデス", 1000001,
            [92, 88, 70, 72, 86, 78, 66, 74]),
        new(0x70000002, "ユリアン・ミンツ", OriginalFaction.Alliance, 2, 1,
            "ミンツ", "ユリアン", "アルタイル", 1000001,
            [78, 80, 68, 74, 82, 76, 72, 84]),
        new(0x70000003, "アッテンボロー", OriginalFaction.Alliance, 3, 1,
            "アッテンボロー", "ダスティ", "リゲル", 1000001,
            [84, 77, 62, 70, 73, 88, 82, 69]),
        new(0x70000004, "シェーンコップ", OriginalFaction.Alliance, 4, 1,
            "シェーンコップ", "ワルター", "ベテルギウス", 1000001,
            [76, 83, 60, 66, 68, 91, 90, 75]),
        new(0x70000005, "キャゼルヌ", OriginalFaction.Alliance, 1, 1,
