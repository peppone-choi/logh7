...
[IO.File]::WriteAllText($OutputPath,(($out|ConvertTo-Json -Depth 10)+[Environment]::NewLine),[Text.UTF8Encoding]::new($false));Write-Output 'HOST_PORT47900_BINDING_WRITTEN'
